...
int main()
{
	...
	Kitt_M = Model();
	Kitt_M.LoadModel("Models/Sulley/source/Sulley/chasisSully.obj");
	Llanta_M = Model();
	Llanta_M.LoadModel("Models/Sulley/source/Sulley/llantaIzquierdaSully.obj");
	Blackhawk_M = Model();
	Blackhawk_M.LoadModel("Models/uh60.obj");
	Puerta_M = Model();
	Puerta_M.LoadModel("Models/Puerta/source/puerta.obj");
	...
	glm::vec4 posLocal(0.0f);
	glm::vec3 posMundo(0.0f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[2].SetFlash(posMundo, direccion);
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.7f, -2.1f, 1.7f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
