...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	{
		if (theWindow->articulacion3 <= 70.0)
			theWindow->articulacion3 += 30.0;
	}
	if (key == GLFW_KEY_H && action == GLFW_RELEASE)
	{
		if (theWindow->articulacion3 >= 0.0)
			theWindow->articulacion3 -= 30.0;
	}
	/*if (key == GLFW_KEY_J)
	{
	...
	{
		if (theWindow->articulacion4 <= 150.0)
			theWindow->articulacion4 += 30.0;
	}
	...
	{
		if (theWindow->articulacion5 <= 150.0)
			theWindow->articulacion5 += 15.0;
	}
	if (key == GLFW_KEY_K && action == GLFW_RELEASE)
	{
		if (theWindow->articulacion5 >= 0.0)
			theWindow->articulacion5 -= 15.0;
	}
	if (key == GLFW_KEY_L)
	{
	...
	if (key == GLFW_KEY_N)
	{
		theWindow->articulacion9 -= 0.1;
	}
	if (key == GLFW_KEY_M)
	{
		theWindow->articulacion10 += 0.1;
	}
	/*if (key == GLFW_KEY_Y)
	{
	...
	{
		if (theWindow->articulacion13 <= 70.0)
			theWindow->articulacion13 += 20.0;
	}
	if (key == GLFW_KEY_P && action == GLFW_RELEASE)
	{
		if (theWindow->articulacion13 >= 0.0)
			theWindow->articulacion13 -= 20.0;
	}
	if (key == GLFW_KEY_Z)
	{
	...
	{
		if (theWindow->articulacion18 <= 60.0)
			theWindow->articulacion18 += 20.0;
	}
	if (key == GLFW_KEY_B && action == GLFW_RELEASE)
	{
		if (theWindow->articulacion18 >= 0.0)
			theWindow->articulacion18 -= 20.0;
	}
